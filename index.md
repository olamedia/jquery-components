...
<div class="jumbotron" style="padding: 0; padding-top: 30px; background: #fff; background: linear-gradient(to bottom, rgba(255,255,255,1) 0%,rgba(255,255,255,1) 28%,rgba(255,255,255,0.5) 53%,rgba(255,255,255,1) 87%,rgba(255,255,255,1) 100%) left top repeat-x, url({{ site.baseurl }}/css/images/hero-bg.png) left top repeat;">
